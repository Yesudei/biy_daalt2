...
class TootsooluurSubmitPage extends StatefulWidget {
  const TootsooluurSubmitPage({super.key});

  @override
  State<TootsooluurSubmitPage> createState() => _TootsooluurSubmitPageState();
}

class _TootsooluurSubmitPageState extends State<TootsooluurSubmitPage> {
...
class RepaymentSchedule extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> schedule = List.generate(5, (index) => {
      'date': '2022.05.15',
      'balance': '3,732,395₮',
      'principal': '267,604₮',
      'interest': '40,000₮',
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          backgroundColor: isEnabled ? const Color(0xFFFF6D31) : Colors.grey,
